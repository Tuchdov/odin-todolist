...
export function handleTaskClick(event, app, domManipulator = document) {
  ...
  if (taskDltBtn) {
    ...
    // get form fields
    const taskNameInput = domManipulator.querySelector(
      "#task-title-edit-input",
    );
    const taskDescriptionInput = domManipulator.querySelector(
      "#task-description-edit-input",
    );
    const taskPriorityInput = domManipulator.querySelector(
      "#task-priority-edit-input",
    );
...
export function initAddTaskButton(app, domManipulator = document) {
  ...
  const descriptionInput = domManipulator.querySelector(
